...
export type GenerateFunction<T extends GenerateOptions> = (content: string, config?: T) => Promise<string>;
export type GenerateFunctionSync<T extends GenerateOptionsSync> = (content: string, config?: T) => string;
